...
def sto_algorithm(N, max_evaluations, lb, ub, data):
    ...
    for t in range(T):
        for i in range(N):
            ...
            r = np.random.uniform(0, 1)  # Random value instead of chaotic sequence
...
# Main function
def main():
    dataset_path = '/content/drive/My Drive/Colab Notebooks/Clustering/Data_set/diabetes.csv'
    ...
    max_evaluations = 10000 * dim

    output_path = "/content/drive/My Drive/Colab Notebooks/Clustering/results/ssto"
    ...
    csv_path = os.path.join(output_path, "diabetes_iter_ssto.csv")
